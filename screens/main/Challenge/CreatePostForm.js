...
export default class CreatePostForm extends React.Component {
  ...
  render() {
    ...
    var comingFromDraft =
      postData && postData.fromDraft != undefined ? true : false;
    ...
    return (
      <ImageBackground
        source={this.state.thumb ? { uri: this.state.thumb } : null}
        resizeMode="cover"
        style={styles.slide}
      >
        <Formik
                ...
                >
                  ...
                  <View style={styles.upperBox}>
                    <Icon
                      type="EvilIcons"
                      name="location"
                      style={{ color: Colors.violetXblue }}
                    />
                    <Field
                      name="Location"
                      placeholderTextColor={Colors.white}
                  ...
                  <View style={{ flex: 1, justifyContent: 'space-between' }}>
                    <View style={styles.DownBox}>
                      {this.props.hostAHunt == undefined &&
                        !hostAHuntSnapOff && (
                          <Field
                            name="privacy"
                            component={CustomPicker}
                            placeholder={'Who can view this challenge'}
                            list={privacy}
                          />
                        )}
                    </View>
                    <View style={styles.DownBox}>
                      ...
                      {values.category != 'null' && (
                        <Field
                          ...
                          season1={season1}
                          enable={!disabled}
                          list={season1 ? categories_system : categories}
                        />
                      )}
                    </View>

                    {this.props.featured == 'active' &&
                      !isFeatured && (
                        <View>
                          <View style={styles.DownBox}>
                            <View
                    ...
                    >
                      {this.props.hostAHunt == undefined && (
                        <DarkOutlineButton
                          updateRef={this.props.updateSaveChallengeRef}
                          text="Post Moment"
                          style={{
                            backgroundColor:
                              colorGetterFromProps.backgroundColor,
                            width: '100%',
